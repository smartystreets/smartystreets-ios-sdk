...
- (NSString*)run {
    ...
    InternationalStreetClient* client = [[ClientBuilder alloc] initWithId:@"KEY" hostname:@"hostname"].withLicenses(["international-global-plus-cloud"]).buildInternationalStreetApiClient;
