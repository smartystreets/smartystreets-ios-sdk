...
class USEnrichmentPrincipalResultTest: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
        expectedJsonInput = """
        {"business_name":"","city":"2","custom_param_array":{},"data_set_name":"property","data_subset_name":"principal","etag":"6","exclude_array":["9","10"],"features":"5.1","freeform":"5","include_array":["7","8"],"smarty_key":"xxx","state":"3","street":"1","zipcode":"4"}
        """
