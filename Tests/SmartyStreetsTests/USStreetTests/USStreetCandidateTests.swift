...
class USStreetCandidateTests: XCTestCase {
    ...
    override func setUp() {
        super.setUp()
        expectedJsonInput = """
        [{\"addressee\":\"addressee_value\",\"city\":\"city_value\",\"customParamArray\":{},\"lastline\":\"lastline_value\",\"matchStrategy\":\"match_value\",\"maxCandidates\":5,\"result\":[],\"secondary\":\"secondary\",\"state\":\"state_value\",\"street\":\"street_value\",\"street2\":\"street2_value\",\"urbanization\":\"urbanization_value\",\"zipCode\":\"zipCode_value\"},{\"city\":\"Mountain view\",\"customParamArray\":{},\"result\":[],\"state\":\"California\",\"street\":\"1600 amphitheatre parkway\"},{\"customParamArray\":{},\"result\":[],\"street\":\"1 Rosedale, Baltimore, Maryland\"}]
        """
