...
public class InternationalStreetClient: NSObject {
    ...
    @objc public func sendLookupWithAuth(lookup: UnsafeMutablePointer<InternationalStreetLookup>, authId:String?, authToken:String?, error: UnsafeMutablePointer<NSError?>) -> Bool {
