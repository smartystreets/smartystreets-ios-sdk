...
public class InternationalAutocompleteClient: NSObject {
    ...
    func buildRequest(lookup:InternationalAutocompleteLookup) -> SmartyRequest {
        ...
        request.setValue(value: lookup.maxGroupResults.flatMap { String($0) } ?? "100", HTTPParameterField: "max_group_results")
        if lookup.geolocation {
            request.setValue(value: "on", HTTPParameterField: "geolocation")
        }
