...
@objcMembers public class USStreetCandidate: NSObject, Codable {
    ...
    var deliveryLine1:String?
    var deliveryLine2:String?
    var lastline:String?
    var deliveryPointBarcode:String?
    var components:USStreetComponents?
    var metadata:USStreetMetadata?
    var analysis:USStreetAnalysis?
