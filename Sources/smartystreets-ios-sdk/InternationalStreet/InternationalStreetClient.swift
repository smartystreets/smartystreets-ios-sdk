...
class InternationalStreetClient: NSObject {
    ...
    @objc func sendLookup(lookup: UnsafeMutablePointer<InternationalStreetLookup>, error: UnsafeMutablePointer<NSError?>) -> Bool {
